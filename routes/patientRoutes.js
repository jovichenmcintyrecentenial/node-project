...
const {updatePatient,addPatient,getAllPatients, getPatient, deletePatient,addPatientsTestRecord, deletePatientTest, updatePatientTest} = require('./../controllers/patientController');
